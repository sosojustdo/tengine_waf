#define NGX_CONFIGURE " --prefix=/usr/local/tengine --with-http_lua_module --with-luajit-inc=/usr/local/lj2/include/luajit-2.0 --with-pcre=/home/caobin/kuaidi/software/pcre-8.33 --with-luajit-lib=/usr/local/lj2/lib --with-openssl=/home/caobin/kuaidi/software/openssl-1.0.1h --with-zlib=/home/caobin/kuaidi/software/zlib-1.2.8"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/local/tengine/"
#endif
